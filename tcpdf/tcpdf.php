...
class TCPDF {
	...
	public function Header() {
        // Logo
        $image_file = 'img/logoclinica.png';
        $this->Image($image_file, 180, 10, 20, 21, 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false);
        // Set font
	...
	public function Footer() {
       ...
       // $this->SetFont('helvetica', 'I', 8);
        // Page number
        $image_file = 'img/pieclinicaancho.png';
        $this->Image($image_file, 10, '', 190, 18, 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false);
    }
	...
	protected function getHtmlDomArray($html) {
		...
		$html = strip_tags($html, '<marker/><a><b><blockquote><body><br><br/><dd><del><div><dl><dt><em><font><form><h2><h2><h3><h4><h5><h6><hr><hr/><i><img><input><label><li><ol><option><p><pre><s><select><small><span><strike><strong><sub><sup><table><tablehead><tcpdf><td><textarea><th><thead><tr><tt><u><ul>');
