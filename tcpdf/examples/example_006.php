...
// create some HTML content
$html = '<h2>Image alignments on HTML table</h2>
...
$textcolors = '<h2>HTML Text Colors</h2>';
$bgcolors = '<hr /><h2>HTML Background Colors</h2>';
...
$html = <<<EOF
<h2>Test custom bullet image for list items</h2>
