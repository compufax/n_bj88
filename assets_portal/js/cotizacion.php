...
echo '
	...
	if($_POST['cmd']!="ver_producto"){
		...
		<tr bgcolor="#E9F2F8"><th rowspan="2">Producto</th><th colspan="2">Velocidad impresi�n (BN/Color)</th><th rowspan="2">(BN/Color)</th><th colspan="4">Funciones</th>
		...
		<div id="tabs">
			<ul>
				<li><a hrer="#tabs-1">Informaci�n del producto</a></li>
				<li><a hrer="#tabs-2">Vistas del producto</a></li>
				<li><a hrer="#tabs-4">Especificaci�n t�cnica</a></li>
			</ul>
			<div id="tabs-1">
		...
		echo '</ul></div>
			...
			if($row['es_copiadora']==1){
				...
				$rc=TRUE;
				rowb(); echo '<th align="left" valign="top" width="200">Tama�o m�x. de original</th><td>'.$row['copia_tam_max'].'</td></tr>';
				rowb(); echo '<th align="left" valign="top" width="200">Funciones de copia digital</th><td>'.$row['copia_func_copia_dig'].'</td></tr>';
				rowb(); echo '<th align="left" valign="top" width="200">Modo de exposici�n</th><td>'.$row['copia_modo_exp'].'</td></tr>';
				rowb(); echo '<th align="left" valign="top" width="200">Porcentajes de ampliaci�n/reducci�n</th><td>'.$row['copia_porc_amp_redu'].'</td></tr>';
			...
			if($row['es_escaner']==1){
				...
				rowb(); echo '<th align="left" valign="top" width="200">Tama�o m�x. de escaneo</th><td>'.$row['scan_tamano_max'].'</td></tr>';
				rowb(); echo '<th align="left" valign="top" width="200">Funcionalidad</th><td>'.$row['scan_funcionalidad'].'</td></tr>';
				rowb(); echo '<th align="left" valign="top" width="200">Resoluci�n de escaneo</th><td>'.$row['scan_resolucion'].'</td></tr>';
			...
			if($row['es_fax']==1){
				...
				rowb(); echo '<th align="left" valign="top" width="200">Tama�o m�x. de original</th><td>'.$row['fax_tam_original'].'</td></tr>';
				rowb(); echo '<th align="left" valign="top" width="200">M�todo de compresi�n</th><td>'.$row['fax_metodo_compresion'].'</td></tr>';
