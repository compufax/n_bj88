...
function obtener_informacion($datos){
	...
	$select .= " FROM vale_cortesia_credito a";
	if($datos['mostrar']<2){
		if($datos['mostrar']==0){
			$select .= " LEFT";
		}
		...
		$select .= " JOIN cobro_engomado d ON a.plaza = d.plaza AND a.folio = d.codigo_cortesia AND d.tipo_venta=2 AND d.tipo_cortesia=4";
	}
	...
	<div class="col-xl-12 col-lg-12 col-md-12">
        ...
        <div class="form-group row">
			...
			<div class="col-sm-4">
            	...
            	<?php
            	$res1 = mysql_query("SELECT b.cve, b.usuario FROM (SELECT usuario FROM vale_cortesia_credito WHERE plaza='{$_POST['cveplaza']}' GROUP BY usuario) a INNER JOIN usuarios b ON b.cve = a.usuario ORDER BY b.usuario");
        ...
        <div class="form-group row">
			...
			<div class="col-sm-4">
            	...
            	<?php
            	$res1 = mysql_query("SELECT cve, nombre FROM depositantes WHERE plaza='{$_POST['cveplaza']}' AND tipo_depositante=4 ORDER BY nombre");
				while($row1=mysql_fetch_array($res1)){
